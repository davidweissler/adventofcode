...
func processInput2(_ input: String) {
  ...
  var maxRow = 0
  var maxCol = 0
  coordinatesSet.forEach {
    maxCol = max(maxCol, $0.col)
    maxRow = max(maxRow, $0.row)
  }
  
  var grid: [[String]] = Array(repeating: Array(repeating: " ", count: maxCol + 1), count: maxRow + 1)
  coordinatesSet.forEach { grid[$0.row][$0.col] = "#" }
